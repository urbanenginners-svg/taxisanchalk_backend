...
const SUBJECT_TEMPLATE = 'Low Stock Alert - {{productName}} (SKU: {{variantSku}})';
  ...
  <body style="font-family: Arial, sans-serif; background:#f9fafb; padding:20px;">
    ...
    <div style="max-width:600px; margin:auto; background:#ffffff; border:1px solid #e5e7eb; border-radius:8px; padding:20px;">
      ...
      <table style="width:100%; border-collapse: collapse; font-size:14px;">
        ...
        <tr>
          <td style="padding:8px; font-weight:bold;">Available Stock</td>
        ...
        <tr style="background:#f3f4f6;">
          <td style="padding:8px; font-weight:bold;">Reserved Stock</td>
          <td style="padding:8px;">{{reserved}}</td>
        </tr>

        <tr>
          <td style="padding:8px; font-weight:bold;">Physical Stock</td>
          <td style="padding:8px;">{{physical}}</td>
        </tr>

        <tr style="background:#f3f4f6;">
          <td style="padding:8px; font-weight:bold;">Min Stock Level</td>
          <td style="padding:8px;">{{minStockLevel}}</td>
        </tr>
...
export function lowStockAlertTemplate(variables: Record<string, string>) {
  return {
